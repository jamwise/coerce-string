  ...
  string(value) {
    ...
    for(let i = 0; i < charArray.length; i++) {
      ...
      if(a in this.specialTypes) {
        ...
        */
        const regexp = new RegExp('^'+this.specialTypes[a], 'i');
        ...
        if(string[0] !== '' && !!string[0]){
          ...
          */
          let shouldPush;
          if(charArray[i-1] in this.specialTypes) {
          ...
          */
          ...
          /*
            ...
            impossible)
          */
          const isDelete = this.value && this.value.length > value.length;
